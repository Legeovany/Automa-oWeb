...
public class ValidandoLoginComSucesso {
	...
	public void que_o_usuario_estar_na_tela_de_login() throws Throwable {
		loginPage.validarYoutubeHome();
	}
	
	@Given("que o usuario acesse a home do Youtube")
	public void que_o_usuario_acesse_a_home_do_youtube() throws Throwable {
		loginPage.validarYoutubeHome();
	}
	...
	public void o_usuario_realizar_login_youtube() throws Throwable {
		loginPage.clicarBtnFazerLogin();
		loginPage.EscreverUser();
		loginPage.clicarBtnProxima();
		loginPage.EscreverSenhaYT();
		loginPage.clicarBtnProxima();
	}
